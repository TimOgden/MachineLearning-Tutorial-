...
def find_and_plot_regression(xs, ys):
...
#Sentdex coded it a bit differently than I did, but got the same r^2=0.5844 :)
...
#regression_line = find_and_plot_regression(xs, ys)
